...
internal class ZZZInstallGameService : InstallGameService
{
    ...
    public ZZZInstallGameService(ILogger<ZZZInstallGameService> logger, GameResourceService gameResourceService, LauncherClient launcherClient, HttpClient httpClient)
    ...
    protected override async Task VerifySeparateFilesAsync(CancellationToken cancellationToken)
    {
        ...
        // 删除不在资源列表中的文件
        string assetsFolder = @"ZenlessZoneZero_Data\StreamingAssets";
